import React, { useState, useEffect } from 'react';  // useEffect déjà là, useState implicite
...
// MODIFIÉ : Avec timer de régénération !
...
// --- Écran Principal ---
// [Inchangé – handleLevelPress checke lives, modal s'ouvre si 0]
const LevelSelectScreen = ({ route, navigation }: Props) => {
  ...
  type AlertButton = { text: string; onPress: () => void; style?: string; textColor?: string };  // AJOUT : Type pour clarté (si pas déjà)
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.header}>
        ...
        {/* Indicateur de vies – maintenant avec timer ! */}
